...
float delta[3];         // self test results
...
//  delay(2000);
  ...
  if(c == 0x90 && d == 0xCE && e == 0x1001) // check if all I2C sensors with WHO_AM_I have acknowledged
  {
   ...
   Serial2.print("z-axis self test = "); Serial2.print(delta[2], 1); Serial2.println("mg, should be > 800 mg");
   BMA400.resetBMA400();                                                // software reset before initialization
   ...
   Serial2.print("z-axis offset = "); Serial2.print(offset[2]*1000.0f, 1); Serial2.println(" mg");
